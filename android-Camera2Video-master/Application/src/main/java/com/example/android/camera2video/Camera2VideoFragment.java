...
//     */
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        mButtonImage = (Button) view.findViewById(R.id.image);
...
//    private CaptureRequest mPreviewRequest;
    ...
    private void runPrecaptureSequence() {
        try {
            ...
            mPreviewCaptureSession.capture(mPreviewBuilder.build(), mPreviewCaptureCallback,
                    mBackgroundHandler);
...
//            setAutoFlash(mPreviewBuilder);
            ...
            mCaptureState = STATE_PREVIEW;
            mPreviewCaptureSession.setRepeatingRequest(mPreviewBuilder.build(), mPreviewCaptureCallback,
                    mBackgroundHandler);
        } catch (CameraAccessException e) {
            e.printStackTrace();
        }
    ...
    private void lockFocus(){
        ...
        try{
            mPreviewCaptureSession.capture(mPreviewBuilder.build(), mPreviewCaptureCallback, mBackgroundHandler);
